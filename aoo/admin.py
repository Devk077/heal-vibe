...
class PatientAdmin(admin.ModelAdmin):
    form = PatientForm
    list_display = ('name', 'phone', 'email', 'age', 'sex', 'weight', 'height', 'blood_group', 'purpose') #list of item shown on the home page of the admin panel
    fieldsets = [
        ('Personal Information', {'fields': ['name', 'phone', 'email', 'occupation', 'address', 'age','sex', 'marital_status']}), 
        ...
        ('food Information', {
            'fields': (('oil_or_ghee_brand', 'salt_used',),('rice_used', 'flour_used'),( 'milk_used')),
            'classes': ('wide', 'extrapretty'),
        }),
    ]
...
class MealPlanAdmin(admin.ModelAdmin):
    inlines = (After_BedInline,BreakfastInline, LunchInline, SnacksInline, DinnerInline, Before_BedInline, pre_workoutInline, post_workoutInline)
    list_display = ('name', 'After_Bed', 'Breakfast', 'Lunch', 'Snacks','Dinner', 'Before_Bed','pre_workout', 'post_workout')
    form = MealPlanForm
