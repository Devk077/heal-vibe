...
class AppointmentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'Appointment_description': forms.Textarea(attrs={'class': 'form-control', 'rows': 8, 'cols' : 100, 'placeholder': 'Appointment Description',}),            
        }
...
class PatientForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'marital_status': forms.Select(choices=(('Single','Single'),('Married','Married'),('Divorced','Divorced'),('Widowed','Widowed'))),
            ...
            'family_history': forms.Textarea(attrs={'rows': 5, 'cols': 100, 'placeholder': 'Enter Family History(if any?)'}),
            ...
            'food_preferences': forms.Textarea(attrs={'placeholder': 'Veg or Non-Veg or Egg or Chicken or Vegan or Jain or Sea Food or Other', 'rows': 5}),
            'food_taste': forms.Textarea(attrs={'placeholder': 'Spicy or Sweet or Salty or Bitter or Sour or Purgent or Other', 'rows': 5}),
            ...
            'consume_fruits_daily': forms.Textarea(attrs={'placeholder': 'Yes or No(if yes how much?What type?)', 'rows': 5}),
            ...
            'irregular_period_details': forms.Textarea(attrs={'placeholder': 'Enter details about irregular periods(if any?)', 'rows': 5}),
...
class MealPlanForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={'placeholder': 'Enter Name'}),
            'short_description': forms.Textarea(attrs={'rows': 5, 'cols': 100, 'placeholder': 'Enter Short Description'}),
        }
